...
base_url = "http://192.168.0.232:1234/v1"  #Sidan's Server Mistral-7B-Instruct-v0.1-GGUF/mistral-7b-instruct-v0.1.Q8_0.gguf
...
api_model="Mistral-7B-Instruct-v0.1-GGUF/mistral-7b-instruct-v0.1.Q8_0.gguf"
...
#    try:
        ...
        groupchatins = autogen.GroupChat(agents=[user_proxy,coder,pm],messages=[],max_round=100)
